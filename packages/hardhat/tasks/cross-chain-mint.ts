...
task(`cross-chain-mint`, `Mints the new ABT by sending the Cross-Chain Message`)
    ...
    .setAction(async (taskArguments: TaskArguments) => {
        const { sourceBlockchain, sourceMinter, destinationBlockchain, destinationMinter } = taskArguments;
        ...
        await getCcipMessageId(tx, sourceProvider);
